<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('validations.search') }}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-gray-800">
                                    <div>
                                        <button
                                            onclick="window.location.href = '{{ route('validations.show', $validation->id) }}'"
                                        ...
                                        <button
                                            onclick="window.location.href = '{{ route('validations.destroy', $validation->id) }}'"
                                        ...
                                        <button
                                            onclick="window.location.href = '{{ route('validations.edit', $validation->id) }}'"
